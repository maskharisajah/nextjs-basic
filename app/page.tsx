...
export default function Home() {
  return (
    <div className='space-y-10'>
      <h1>Home</h1>
      {/* experiment 1 */}
      {/* default fill posisinya absolut */}
      ...
      />
      {/* local image cara 1*/}
      <Image src={gambarGunung} alt='gambar gunung' />

      {/* local image cara 2 */}
      <Image src='/photo1.jpg' alt='gambar gunung' width={80} height={60} />
    </div>
  );
}
